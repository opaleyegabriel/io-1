  ...
  return (
    ...
    <View style={tw`flex-1 mt-20 bg-gray-100`}>
      ...
      />
        ...
        <ProfileHeadInfo />
        <RideBalance balance={rideBalance} />
      </Animated.View>
      ...
      <Text style={tw`text-sm text-gray-700 mb-4`}>
        Add money to your account here via Paystack, transfer, and other methods to enable you to use our transport services.
      </Text>
    </View>
...
export default AddRiderBalance;
