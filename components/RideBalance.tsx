  ...
  return (
    ...
    >
       <View style={tw`flex-row items-center mb-1`}>
        <MaterialCommunityIcons name="bicycle" size={20} color="white" />
        <Text style={tw`ml-2 text-xl font-semibold text-white`}>Ride</Text>
      </View>

      <View style={tw`flex-row gap-9`}>
