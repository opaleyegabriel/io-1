...
import { SimpleLineIcons } from '@expo/vector-icons'; // For icons
import tw from 'twrnc'; // TailwindCSS for styling

const PROWBalance = ({ balance }) => {
  ...
  return (
    ...
    >
      <View style={tw`flex-row items-center mb-1`}>
        ...
        <Text style={tw`ml-2 text-xl font-semibold text-white`}>Pre Order Wallet</Text>
      </View>
